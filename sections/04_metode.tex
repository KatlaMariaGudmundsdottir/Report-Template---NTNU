...
\lhead{Implementation - Wireless IMU Integration}
\subsection{Wireless IMU Integration}
...
\begin{figure} [h]
    \centering
    \includegraphics[width=0.8\linewidth]{images/goodkneeangleref.png}
    \caption{Caption}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{images/fittedKneeAngleRef.png}
    \caption{Caption}
    \label{fig:enter-label}
\end{figure}
\newline
